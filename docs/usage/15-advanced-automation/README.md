...
这一目录下还提供了一组可复用的 skill pack，方便 AI 按场景使用这些 `cts` 命令：

- skill pack 入口：[automation-workbench/README.md](automation-workbench/README.md)
- 维护目录：[automation-workbench/CATALOG.md](automation-workbench/CATALOG.md)
- 包定义：[automation-workbench/manifest.yaml](automation-workbench/manifest.yaml)

`automation-workbench` 根目录不是 skill，本身只负责承载公共资产、模板和目录约定。真正可执行的是下面这 22 个并列子 skill：

- [app-context-init](automation-workbench/app-context-init/SKILL.md)
- [performance-baseline](automation-workbench/performance-baseline/SKILL.md)
- [code-review-assistant](automation-workbench/code-review-assistant/SKILL.md)
- [integration-test-platform](automation-workbench/integration-test-platform/SKILL.md)
- [dingtalk-webhook-notify](automation-workbench/dingtalk-webhook-notify/SKILL.md)
- [implementation-acceptance](automation-workbench/implementation-acceptance/SKILL.md)
- [incident-diagnosis](automation-workbench/incident-diagnosis/SKILL.md)
- [log-query](automation-workbench/log-query/SKILL.md)
- [mcp-cli-bootstrap](automation-workbench/mcp-cli-bootstrap/SKILL.md)
- [resource-management](automation-workbench/resource-management/SKILL.md)
- [alert-response-containment](automation-workbench/alert-response-containment/SKILL.md)
- [solution-review](automation-workbench/solution-review/SKILL.md)
- [engineering-collaboration](automation-workbench/engineering-collaboration/SKILL.md)
- [release-checklist-generator](automation-workbench/release-checklist-generator/SKILL.md)
- [release-verify](automation-workbench/release-verify/SKILL.md)
- [requirements-development](automation-workbench/requirements-development/SKILL.md)
- [security-review](automation-workbench/security-review/SKILL.md)
- [self-evolution](automation-workbench/self-evolution/SKILL.md)
- [task-scheduling-execution](automation-workbench/task-scheduling-execution/SKILL.md)
- [technical-solution-writing](automation-workbench/technical-solution-writing/SKILL.md)
- [implementation-plan-writing](automation-workbench/implementation-plan-writing/SKILL.md)
- [data-management](automation-workbench/data-management/SKILL.md)
